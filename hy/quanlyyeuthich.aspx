<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="quanlyyeuthich.aspx.cs" Inherits="hy.quanlyyeuthich" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link rel="stylesheet" href="bootstrap/js/pro.js">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="container">
            <div class="row">
                <div class="page-head-content">
                    <h1 class="page-title">DANH MỤC BẤT ĐỘNG SẢN YÊU THÍCH</h1>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class=" form-inline">
                                    ...
                                    <fieldset class="padding-5">
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <div class="checkbox">
                                                    <label> <input type="checkbox" checked> Máy lạnh</label>
                                                </div>
                                            </div>

                                            <div class="col-xs-6">
                                                <div class="checkbox">
                                                    <label> <input type="checkbox"> Bồn rửa đôi</label>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset class="padding-5">
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <div class="checkbox">
                                                    <label> <input type="checkbox" checked> Cửa sổ</label>
                                                </div>
                                            </div>
                                            <div class="col-xs-6">
                                                <div class="checkbox">
                                                    <label> <input type="checkbox" checked> Bể bơi </label>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset class="padding-5">
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <div class="checkbox">
                                                    <label><input type="checkbox">Phòng giặt ủi</label>
                                                </div>
                                            </div>
                                            <div class="col-xs-6">
                                                <div class="checkbox">
                                                    <label> <input type="checkbox">Sân chơi</label>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset class="padding-5">
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <div class="checkbox">
                                                    <label> <input type="checkbox" checked> Sân gon </label>
                                                </div>
                                            </div>
                                            <div class="col-xs-6">
                                                <div class="checkbox">
                                                    <label> <input type="checkbox"> Có gác lửng </label>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset class="padding-5">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="checkbox">
                                                    <label> <input type="checkbox"> Lang can </label>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
									...
									<div class="col-sm-6 col-md-4 p0 " style="left: 0px; top: 0px; width: 254px; height: 398px" >
										<div class="box-two proerty-item ">
											<div class="item-thumb">
												...
												<a >
													<%--<asp:ImageButton ID="ImageButton1" runat="server" CommandArgument='<%# Eval("mabds") %>' ImageUrl='<%# "../imgs/"+ Eval("hinhanh") %>' OnClick="ImageButton1_Click"/>--%>
													<asp:ImageButton ID="ImageButton1" runat="server" CommandArgument='<%# Eval("mabds") %>' ImageUrl='<%# "../imgs/"+ Eval("hinhanh") %>' OnClick="ImageButton1_Click" />
											...
											<div class="item-entry overflow">
												...
												<h5><asp:LinkButton ID="linkbds" runat="server" CommandArgument='<%# Eval("mabds") %>' OnClick="linkbds_Click" Text='<%# Eval("tenbds") %>'></asp:LinkButton></h5>
    ...
    <script src="bootstrap/js/pro.js"></script>
