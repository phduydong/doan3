...
namespace hy
{
	public partial class postt : System.Web.UI.Page
	{
		l data = new l();
		...
		protected void btndang_Click(object sender, EventArgs e)
		{
			...
			string sql = "insert into batdongsan values (N'" + txttenbds.Text + "','" + txtgia.Text + "',N'" + txtmota.Text + "',N'" + drdiachi.SelectedValue.ToString() + "',N'" + hinhanh + "',N'" + user + "',N'" + dropDownListTT.SelectedValue.ToString() + "','" + txtdientich.Text + "',N'chưa duyệt')";
